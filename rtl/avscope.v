...
//
// This particular version is designed to use an Avalon bus interface, instead
// of a wishbone interface.
//
...
module avscope #(
	...
	begin
		...
		br_pre_av_rdack <= i_av_read;
		br_av_rdack <= (br_pre_av_rdack);
		//
